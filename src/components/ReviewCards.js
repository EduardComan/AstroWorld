...
function ReviewCards() {
  return (
    <div className='cards'>
      <h1 className="text-style">Check out some highlights from 2022!</h1>
      <div className='cards__container'>
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            ...
            <CardItem
              src='https://cms.accuweather.com/wp-content/uploads/2021/12/edit-NETWORK-Planets-align-June-2022.jpg?w=632'
